...
export default class Locality extends Component {
    state = {choosenLabel: 'Western Cape', 
    choosenindex: '0',
    choosen: '0',
    choosenCity: "Choose a City",
    surburb : [{itemKey:1,itemDescription:'Suburb 1'},{itemKey:2,itemDescription:'Suburb 2'},{itemKey:3,itemDescription:'Suburb 3'}],
  ...
  onPickerValueChange=(value, index)=>{
    this.setState(
      ...
      () => {
        var results =[];
        var index=this.state.choosen;
        var prov=Provinces[this.state.choosenindex]
        var data= prov.Cities[index].surburb;
        for (var i = 0; i < data.length; i++) {
           results.push({ "itemKey":i,"itemDescription": data[i]});
          }
        this.setState({surburb : results});
      }
    );
  }
  ...
  render(){
     ...
     <View style={styles.vStyle}>
      ...
      <Picker selectedValue={this.state.choosenLabel} onValueChange={this.onPickerChange}>
    ...
    <Card>
     ...
     <Picker mode="dropdown" selectedValue={this.state.choosenCity} onValueChange={this.onPickerValueChange}>
     ...
     <PickerCheckBox
        ...
        />
     <CardSection>
       <TouchableOpacity style={styles.buttonStyle} onPress={this.City}>
